package com.danielfa11.tarea3AD2024.config;
...
public class SpringFXMLLoader {
    ...
    public Parent load(String fxmlPath) throws IOException {      
        ...
        if (loader.getControllerFactory() != null) {        	
            System.out.println("Controller loaded: " + loader.getControllerFactory().getClass().getName());
        } else {
        	System.out.println(fxmlPath);
            System.out.println("Controller not loaded.");
        }
